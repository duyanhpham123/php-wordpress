<?php
/*
 * Plugin Name: Plugin thêm Tỉnh,Thành phố - Quận,Huyện - Xã,Phường trang thanh toán Woocommerce
 * Plugin URI: https://chowordpress.com/item/plugin-them-tinhthanh-pho-quanhuyen-xaphuong-trang-thanh-toan-woocommerce.html
 * Version: 2.0
 * Description: Chợ bán mẫu website, theme và plugin tất cả về WordPress - https://chowordpress.com
 * Author: Chợ WordPress
 * Author URI: https://chowordpress.com
 * Text Domain: chowordpress-checkout
...
Copyright (C) 2022 Chợ WordPress - www.chowordpress.com
...
if(!class_exists('Woo_Address_Selectbox_Class')) {
    class Woo_Address_Selectbox_Class
    {
        ...
        function admin_menu()
        {
            add_submenu_page(
                'woocommerce',
                __('Plugin thêm Tỉnh,Thành phố - Quận,Huyện - Xã,Phường trang thanh toán Woocommerce', 'devvn-vncheckout'),
        ...
        {
            $action_links = array(
                'upgrade_pro' => '<a href="https://chowordpress.com/item/plugin-tinh-phi-van-chuyen-cho-quan-huyen-trong-woocommerce.html"  target="_blank" style="color: #e64a19; font-weight: bold; font-size: 108%%;" title="' . esc_attr( __( 'Upgrade to Pro', 'devvn-vncheckout' ) ) . '">' . __( 'Upgrade to Pro', 'devvn-vncheckout' ) . '</a>',
        ...
        function devvn_modify_plugin_update_message($plugin_data, $response)
        {
            ...
            echo '<br />' . sprintf(__('<strong>Mua bản quyền để được tự động update. <a href="%s" target="_blank">Xem thêm thông tin mua bản quyền</a></strong> hoặc liên hệ mua trực tiếp qua <a href="%s" target="_blank">facebook</a>', 'devvn-vncheckout'), $PluginURI, 'https://www.facebook.com/nhatnguyenweb');
        }
...
if(!function_exists('vn_checkout_up_to_pro')) {
    ...
    {
        echo '<br><a href="https://chowordpress.com/item/plugin-tinh-phi-van-chuyen-cho-quan-huyen-trong-woocommerce.html" rel="nofollow" target="_blank" style=" text-decoration: none; color: red; font-size: 14px; "> <span class="dashicons dashicons-warning" style=" font-size: 17px; "></span> Chỉ có ở bản PRO</a>';
    }
}
